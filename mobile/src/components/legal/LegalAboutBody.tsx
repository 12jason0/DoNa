...
const styles = StyleSheet.create({
    ...
    heroTitle: { fontSize: 26, fontWeight: "600", textAlign: "center", marginBottom: 10 },
    heroTag: { fontSize: 17, fontWeight: "500", color: "#2563eb", marginBottom: 10, textAlign: "center" },
    ...
    statNumBlue: { fontSize: 22, fontWeight: "600", color: "#2563eb", marginBottom: 4 },
    statNumPurple: { fontSize: 22, fontWeight: "600", color: "#9333ea", marginBottom: 4 },
    statNumGreen: { fontSize: 22, fontWeight: "600", color: "#16a34a", marginBottom: 4 },
    statLabel: { fontSize: 14 },
    stepsSection: { paddingVertical: 28, paddingHorizontal: 4 },
    sectionTitle: { fontSize: 20, fontWeight: "600", textAlign: "center", marginBottom: 18 },
    stepCard: {
        alignItems: "center",
        padding: 16,
        borderRadius: 14,
    ...
    stepTitle: { fontSize: 17, fontWeight: "500", marginBottom: 6, textAlign: "center" },
    ...
    conceptPillText: { color: "#fff", fontSize: 12, fontWeight: "500" },
    courseBody: { padding: 12 },
    courseTitleRow: { flexDirection: "row", alignItems: "center", marginBottom: 6, gap: 8 },
    courseTitle: { flex: 1, fontSize: 16, fontWeight: "600" },
    rating: { fontSize: 14, color: "#eab308", fontWeight: "500" },
    ...
    startBtnText: { color: "#fff", fontSize: 13, fontWeight: "500" },
    ...
    nick: { fontWeight: "500", fontSize: 15 },
    ...
    whyTitle: { fontSize: 22, fontWeight: "600", textAlign: "center", marginBottom: 20 },
    whyCard: {
        borderRadius: 18,
        padding: 22,
    },
    whyH3: { fontSize: 20, fontWeight: "500", marginBottom: 12 },
    ...
    ctaTitle: { fontSize: 22, fontWeight: "600", textAlign: "center", marginBottom: 12 },
    ...
    ctaBtnText: { color: "#fff", fontSize: 16, fontWeight: "500", textAlign: "center" },
});
