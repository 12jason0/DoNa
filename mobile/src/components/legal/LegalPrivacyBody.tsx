...
const styles = StyleSheet.create({
    ...
    link: { color: "#2563eb", textDecorationLine: "underline", fontWeight: "500" },
    ...
    thText: { fontSize: 12, fontWeight: "500" },
    tdText: { fontSize: 12, lineHeight: 18 },
    tdTextBold: { fontSize: 12, lineHeight: 18, fontWeight: "500" },
    calloutBlue: {
        padding: 14,
        borderRadius: 8,
        marginBottom: 16,
    ...
    calloutStrong: { fontSize: 14, fontWeight: "500", marginBottom: 8 },
    ...
    calloutBtnText: { color: "#fff", fontSize: 13, fontWeight: "500" },
