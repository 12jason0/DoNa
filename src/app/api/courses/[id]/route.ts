...
export async function GET(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
    ...
    try {
        ...
        const payload = {
            ...
            description: hasAccess ? course.description || "" : "",
            description_en: hasAccess ? course.description_en || null : null,
            description_ja: hasAccess ? course.description_ja || null : null,
            description_zh: hasAccess ? course.description_zh || null : null,
            sub_title: hasAccess ? course.sub_title : null,
            target_situation: course.target_situation || null,
            duration: course.duration || null,
            budget_range: course.budget_range || null,
            isSelectionType: course.isSelectionType === true,
