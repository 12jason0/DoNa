                    ...
                    <div className="pb-6">
                        ...
                        <div className="mb-3 flex gap-2">
                            ...
                            <button
                                ...
                                className="px-4 py-2 bg-[#99c08e] text-white rounded-lg text-sm font-medium hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                            >
                                추가
                            </button>
                        </div>
