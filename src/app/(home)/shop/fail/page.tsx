    ...
    return (
        <div className="min-h-screen bg-white dark:bg-[#0f1710] flex items-center justify-center">
            <div className="text-center max-w-md mx-auto px-4">
                ...
                <h2 className="text-2xl font-bold mb-2 text-gray-900 dark:text-white">{t("payment.failTitleFailed")}</h2>
                <p className="text-gray-500 dark:text-gray-400 mb-6">{t("payment.failDescRetry")}</p>
                <button
