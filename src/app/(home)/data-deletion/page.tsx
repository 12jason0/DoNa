                ...
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="prose prose-lg max-w-none leading-relaxed text-gray-700">
                        ...
                        <section className="mb-8">
                            ...
                            <h4 className="text-lg font-semibold text-gray-900 mb-2 mt-4">마이페이지를 통한 탈퇴</h4>
                            ...
                            <h4 className="text-lg font-semibold text-gray-900 mb-2 mt-4">이메일을 통한 탈퇴 요청</h4>
                        ...
                        <section className="mb-8">
                            ...
                            <p className="text-sm text-gray-600">
                                ...
                                자세한 내용은{" "}
                                <a href="/privacy#retention" className="text-blue-600 hover:underline">
