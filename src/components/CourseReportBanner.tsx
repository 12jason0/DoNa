            ...
            >
                ...
                <div className="relative z-10 flex flex-col gap-3">
                    ...
                    <div className="flex flex-col gap-2.5">
                        <h3 className="text-lg font-black leading-tight tracking-tight whitespace-pre-line">
                            {t("courseReportBanner.title")}
                        </h3>
                        <p className="text-xs font-medium text-white/90 leading-relaxed">
                            {t("courseReportBanner.subtitle")}
                        </p>
                    </div>
                    ...
                    >
                        ...
                        <span>{t("courseReportBanner.cta")}</span>
                    </button>
                </div>
            </div>
